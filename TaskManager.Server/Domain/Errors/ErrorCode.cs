...
public static class ErrorCode
{
    ...
    public static readonly ValidationError TASK_NOT_FOUND = new Error("Task not found");

    public static readonly ValidationError REMINDER_CANNOT_BE_IN_THE_PAST = new Error("Reminder cannot be in the past");

    public static readonly ValidationError TAG_NOT_FOUND = new Error("Tag not found");
